...
public class CList
{
    ...
    /****************************************************************/
    // プレイヤー数
    public readonly static int NUMBER_OF_PLAYERS = 2;

    // ノード数
    public readonly static int NUMBER_OF_FIELD_NODES = 28;    // フィールド
    public readonly static int NUMBER_OF_BENCH_NODES = 12;    // ベンチ
    public readonly static int NUMBER_OF_PC_NODES = 4;        // PC
    public readonly static int NUMBER_OF_WALK_NODES = NUMBER_OF_FIELD_NODES + NUMBER_OF_BENCH_NODES + NUMBER_OF_PC_NODES;  // フィールド+ベンチ(MP移動するノード)
    public readonly static int NUMBER_OF_US_NODES = 12;       // ウルトラスペース
    public readonly static int NUMBER_OF_REMOVED_NODES = 12;  // 除外ゾーン

    // 特別なノード番号
    // エントリー
    public readonly static int NODE_ID_ENTRY_PLAYER0_LEFT = 21;
    public readonly static int NODE_ID_ENTRY_PLAYER0_RIGHT = 27;
    public readonly static int NODE_ID_ENTRY_PLAYER1_LEFT = 0;
    public readonly static int NODE_ID_ENTRY_PLAYER1_RIGHT = 6;

    // ゴール
    public readonly static int NODE_ID_GOAL_PLAYER0 = 24;
    public readonly static int NODE_ID_GOAL_PLAYER1 = 3;

    // ベンチ(各プレイヤーについてFigureParameterのbenchIdの最若のものから連番)
    public readonly static int NODE_ID_BENCH_PLAYER0_TOP = 28;
    public readonly static int NODE_ID_BENCH_PLAYER1_TOP = 34;

    // PC
    // _Xは気絶して格納される側を0とした
    public readonly static int NODE_ID_PC_PLAYER0_0 = 40;
    public readonly static int NODE_ID_PC_PLAYER0_1 = 41;
    public readonly static int NODE_ID_PC_PLAYER1_0 = 42;
    public readonly static int NODE_ID_PC_PLAYER1_1 = 43;
    ...
    // オブジェクト名
    public readonly static string BOARD_MASTER = "BoardMaster";
    public readonly static string LOCAL_MASTER = "LocalMaster";
    public readonly static string SPIN_MASTER = "SpinMaster";
